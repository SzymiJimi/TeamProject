...
std::list<Product> Product::loadFromFile(){
    QFileInfo check_file("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//products.txt");
    ...
    }else
    {
     ...
     QFile in("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//products.txt");
...
void Product::saveToFile(std::list<Product> products){
    QFile caFile("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//products.txt");
