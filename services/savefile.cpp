...
{
    QFileInfo check_file("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//clients.txt");
    ...
    }else
    {
     ...
     QFile in("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//clients.txt");
...
void SaveFile::saveClientsToFile(std::list<Client> clients){
    QFile caFile("D://Wojtek//Studia//Programowanie//C++//qt//TeamProject-master//files//clients.txt");
